...
//            return 'success';
        ...
        return redirect()->route("wedding_package.create")->with("toast","Wedding Package Add Successful");
    }
...
//            "photo" => 'image|mimes:jpeg,png,jpg,gif,svg|max:2048'
        ...
        return redirect()->route("wedding_package.index")->with("toast","Wedding Package Updated Successful");
    }
    ...
    public function destroy(WeddingPackage $weddingPackage)
    {
        ...
        return redirect()->route("wedding_package.index")->with("toast","Wedding Package Delete Successful");
    }
}
