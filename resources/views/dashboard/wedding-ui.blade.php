...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('wedding/css/wedding.css') }}">
    <link rel="stylesheet" href="{{ asset('wedding/vendor/summernote/summernote.min.css') }}">
                ...
                <div class="row">
                    <div class="col-12 p-0 ">
                        <nav class="navbar navbar-expand-lg navbar-dark bg-primary" >
                            <a class="navbar-brand" href="#">Wedding Service</a>
                            ...
                            <div class="collapse navbar-collapse " id="navbarSupportedContent">
                                <ul class="navbar-nav ml-auto ">
                                    ...
                                    <li class="nav-item px-3 ">
                                        <a class="nav-link " href="{{ route('package.packageList') }}"><i class="fas fa-layer-group fa-fw"></i> Package</a>
                                    </li>
                                    <li class="nav-item px-3 ">
                                        <a class="nav-link" href="{{ route('blog.blogList') }}"><i class="fab fa-blogger"></i> Blog</a>
                                    </li>
                                    <li class="nav-item px-3 ">
                                        <a class="nav-link" href="{{ route('recommend.recommendList') }}"><i class="fas fa-star text-white fa-fw"></i> Recommend</a>
                                    </li>
                                    <li class="nav-item pl-3 ">
                                        <a class="nav-link" href="{{ asset('/contact') }}"><i class="fas fa-address-card fa-fw"></i> Contact</a>
                                    </li>
...
<script src="{{ asset('wedding/vendor/summernote/summernote.min.js') }}"></script>
